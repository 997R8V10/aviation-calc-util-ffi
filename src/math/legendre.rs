...
#[no_mangle]
unsafe extern "C" fn math_legendre_legendremanager_new() -> *mut LegendreManager {
    return Box::leak(Box::new(LegendreManager::new()));
}

#[no_mangle]
unsafe extern "C" fn math_legendre_legendremanager_legendre_function(ptr: *mut LegendreManager, n: i32, m: i32, x: f64) -> f64 {
    let obj = &*ptr;
...
#[no_mangle]
unsafe extern "C" fn math_legendre_legendre_polynomial(n: i32) -> *mut Polynomial {    
